...
//  ProjectX
//
//  Created by Binur Balmukhamed on 27.02.2026.
//
...
struct MorphingSymbolView: View {
    ...
    var body: some View {
        ...
        .onChange(of: symbol) { ondValue, newValue in
            trigger.toggle()
            nextSymbol = newValue
        }
        .task {
...
#Preview {
    MorphingSymbolView(symbol: "gearshape.fill",
                       config: .init(font: .system(size: 100, weight: .bold),
